 ...
 * @generated
 */
public abstract class EmployeesFinderBaseImpl
	extends BasePersistenceImpl<Employees> {

	public EmployeesFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return employeesPersistence.getBadColumnNames();
	}

...
public interface studentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>ats.global.techsoft.slayers.service.impl.studentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the student local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link studentLocalServiceUtil} if injection and service tracking are not available.
	 */
